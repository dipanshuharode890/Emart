...
function About() {
    return (
        <>
            ...
            {/* Cards Section */}
            <div className='px-[4%] lg:px-[8%] mt-16 mb-16'>
                    ...
                    {[
                        ...
                        <div key={index} className='group relative bg-white/90 backdrop-blur-md rounded-xl border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 p-3 text-left hover:bg-white'>
                            <div className='overflow-hidden rounded-xl'>
                                <img src={card.img} alt={card.title} className='w-full h-48 object-cover rounded-xl group-hover:scale-105 transition-transform duration-300' />
                            </div>
                            <h3 className='mt-6 text-lg font-semibold text-yellow-500'>{card.title}</h3>
            ...
            <div className="bg-gray-50 py-20 px-[4%] lg:px-[8%]">
                <div className="flex flex-wrap justify-center gap-7 items-start text-center">
                    {[
                        { img: member1, name: 'Thomas Snow', role: "CEO/Founder" },
                        { img: member2, name: 'Emily Grace', role: "Client Care" },
                        { img: member3, name: 'Michael Ray', role: "Support Head" },
                        { img: member4, name: 'Anna Smith', role: "Delivery Driver" },
                        { img: member5, name: 'Lily Adams', role: "Packing Specialist" },
                    ].map((member, idx) => (
                        <div key={idx} className='flex flex-col items-center'>
                            <div className="w-56 h-56 rounded-full border border-gray-300 shadow-md overflow-hidden">
